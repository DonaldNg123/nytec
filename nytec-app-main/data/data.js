...
export default new Category(0, "home", null, [
	new Url(1, "NewGod", 紐神, "https://nytec.net"),

	new Category(2, "HanGod", 漢神, [
		new Url(21, "Hanshinwebsite", 漢神網站, "https://cost.nytec.net"),
		new Url(22, "HanshinSchool", 漢神校務系統, "https://online.nytec.net"),
	]),

	new Url(3, "TheologicalAssemblage", 神學薈萃, "https://workshop.nytec.net"),
	...
	new Url(7, "ContactUs", 聯絡我們, "https://nytec.net/contact-us"),

	new Category(8, "DedicatedSupport", 奉獻支持, [
		new Url(
			81,
			"SupportNewGodsMinistries",
			支持紐神事工,
			"https://nytec.net/donation/"
		),
		new Url(
			82,
			"SupportHanshinMinistries",
			支持漢神事工,
		...
		new Url(
			85,
			"SupportTheologicalEncyclopedia",
			支持神學百科事工,
	...
	new Category(9, "FriendsofHanGod", 漢神之友, [
		new Url(
			91,
			"FriendsofHanGodinOtherCountries",
			美國與其他國家漢神之友,
